deps_config := \
	...
	drivers/power/tps61280a-power/Kconfig \
...
ifneq "$(CC)" "python ../scripts/gcc-wrapper.py /usr/bin/aarch64-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/usr/bin/aarch64-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
